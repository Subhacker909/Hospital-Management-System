...
public class AppointmentDao {
	...
	public boolean addAppointment(Appointment ap) {
		...
		try {
			String sql="insert into appointment(userid,fullname,gender,age,appointdate,email,mobno,diseases,doctorid,address,status) values(?,?,?,?,?,?,?,?,?,?,?)";
...
public Appointment getAppointmentById(int id){
  ...
  public boolean updateAppointmentCommentStatus(int id,int doctId,String comment) {
